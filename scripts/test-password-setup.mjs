...
globalThis.fetch = async (url, options = {}) => {
  ...
  if (requestUrl.startsWith("https://example.supabase.co/rest/v1/")) supabaseHeaders.push(options.headers);
...
await assert.rejects(() => supabaseRequest("applications?select=id&limit=1"), /ENOTFOUND: getaddrinfo failed/);
