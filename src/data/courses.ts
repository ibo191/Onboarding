...
export const courses: CourseLandingData[] = [
  {
    ...
    price: "od 20 000 Kč",
    priceNote: "Auto Základ začíná podle pobočky od 20 000 Kč. Auto Jistota přidává větší prostor na výcvik a klidnější přípravu.",
  ...
  },
  {
    ...
    price: "od 24 900 Kč",
    priceNote: "Auto Základ stojí 24 900 Kč. Auto Jistota stojí 28 900 Kč a dává víc prostoru na klidnější přípravu.",
    primaryCta: "Rezervovat místo",
    secondaryCta: "Jak kurz probíhá",
  ...
  },
  {
    slug: "l17",
    group: "L17",
    badge: "Skupina B od 17 let",
    h1: "Řidičák skupiny B v režimu L17",
    subtitle: "Kurz pro mladé řidiče od 17 let s mentorem, jasným postupem a přehledným onboardingem.",
    price: "od 20 000 Kč",
    priceNote: "Auto Základ začíná podle pobočky od 20 000 Kč. Auto Jistota přidává větší prostor na praxi a klidnější přípravu.",
    primaryCta: "Rezervovat místo",
    secondaryCta: "Jak kurz probíhá",
    heroBenefits: ["Od 17 let", "Mentor", "Studentský portál", "Jasný postup"],
    whoIsItFor: ["Chcete začít s řidičákem už v 17 letech.", "Máte mentora a chcete jasně pochopit celý proces.", "Chcete přehledný postup pro studenta i rodinu."],
    courseIncludes: ["Výcvik skupiny B", "Vysvětlení pravidel režimu L17", "Studentský portál", "Dokumenty a kontrola údajů"],
    timelineSteps,
    whyBuBuBenefits,
    fearBlock: "L17 může působit administrativně složitě. Proto držíme postup přehledný a klidný.",
    availabilityNotice: "Kurz L17 nabízíme podle aktuální kapacity poboček Praha 8 - Střížkov a Kladno.",
    reviews,
    faq: [["Co znamená režim L17?", "Možnost získat řidičské oprávnění skupiny B od 17 let za splnění zákonných podmínek a s mentorem."]],
    seoTitle: "Řidičák od 17 let L17 | Autoškola BuBu Praha a Kladno",
    seoDescription: "Kurz skupiny B v režimu L17 v Autoškole BuBu. Přehledný postup, mentor, studentský portál a klidná příprava.",
  },
  {
